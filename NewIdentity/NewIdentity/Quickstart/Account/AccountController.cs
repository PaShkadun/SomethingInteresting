...
namespace IdentityServerHost.Quickstart.UI
{
    ...
    {
        private readonly UserManager<AuthUser> _users;
        ...
        public async Task<int> ChangePassword([FromBody] ChangePasswordModel model)
        {
        ...
        public async Task<IActionResult> Login(LoginInputModel model, string button)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (!(user is null))
                {
                    isPasswordTrue = await _users.CheckPasswordAsync(user, model.Password);
                }

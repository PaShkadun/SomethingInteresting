        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Persons_Permisions_PermisionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Buckets_Items_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Buckets_Persons_PersonId",
                        column: x => x.PersonId,
                        principalTable: "Persons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderInfos_Persons_PersonId",
                        column: x => x.PersonId,
                        principalTable: "Persons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderHistories_OrderInfos_OrderInfoId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderInfoId = table.Column<int>(type: "int", nullable: false),
                    OrderHistoryEntityId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderItems_OrderHistories_OrderHistoryEntityId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Buckets_ItemId",
                table: "Buckets",
                column: "ItemId");

            migrationBuilder.CreateIndex(
                name: "IX_Buckets_PersonId",
                table: "Buckets",
                column: "PersonId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderHistories_OrderInfoId",
                table: "OrderHistories",
                column: "OrderInfoId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderInfos_PersonId",
                table: "OrderInfos",
                column: "PersonId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderItems_OrderHistoryEntityId",
                table: "OrderItems",
                column: "OrderHistoryEntityId");

            migrationBuilder.CreateIndex(
                name: "IX_Persons_PermisionId",
                table: "Persons",
                column: "PermisionId");
        }
